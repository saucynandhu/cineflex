...
export default function Movies() {
  ...
  return (
    <div className="pt-24 px-4 md:px-12 pb-32">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 no-scrollbar">
          <button
            ...
            className={`px-4 py-1 rounded-full text-sm border ${!selectedGenre ? 'bg-white text-black border-white' : 'border-gray-600 hover:border-white'}`}
          >
            All
          </button>
          {genres.map((genre) => (
            <button
              ...
              className={`px-4 py-1 rounded-full text-sm border whitespace-nowrap ${selectedGenre === genre.id ? 'bg-white text-black border-white' : 'border-gray-600 hover:border-white'}`}
            >
              {genre.name}
            </button>
          ))}
