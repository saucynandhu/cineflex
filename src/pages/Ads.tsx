          ...
          >
            <section className="space-y-6">
              ...
              <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                <p>
                  Cineflex itself is <span className="text-white font-bold underline decoration-red-600 decoration-2">100% ad-free</span>. However, the video players you interact with are hosted by third-party providers (like VidSrc or VidLink).
                </p>
                <p>
